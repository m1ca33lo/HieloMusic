  ...
  run: async (client, interaction, options) => {
    ...
    if (!node) {
      return interaction.reply({
        embeds: [client.ErrorEmbed("El Reproductor no está conectado")],
      });
    }
    ...
    const ret = await interaction.reply({
      embeds: [
        new MessageEmbed()
          ...
          .setImage(client.imagenes.buscando),
      ],
      fetchReply: true,
    });
      ...
      await interaction
        .editReply({
          embeds: [
            new MessageEmbed()
              .setColor("RED")
              .setDescription("Se cometió un erro al buscar"),
          ],
        })
        .catch(this.warn);
    }
      ...
      await interaction
        .editReply({
          embeds: [
            new MessageEmbed()
              .setColor("RED")
              .setDescription("Lo sentimos, no se encontraron resultados de la busqueda"),
          ],
        })
        .catch(this.warn);
    }
